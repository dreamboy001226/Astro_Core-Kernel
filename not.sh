...
OUT_DIR="$(pwd)/out"
ANYKERNEL_DIR="$(pwd)/AnyKernel3/${DEVICE}"
...
make O="$OUT_DIR" vendor/kona-not_defconfig vendor/samsung/kona-sec-not.config vendor/samsung/${DEVICE}.config
